 ...
 *      Author: jefgrailet
 *
 * A simple class to represent an inferred router (during alias resolution). It simply consists in 
...
public:
     ...
     * provided as a parameter (because having a pointer to the environment singleton in Router 
    ...
    static bool compareBis(Router *r1, Router *r2);
