...
const unsigned short ConfigFileParser::N_PARAM_TIMEVAL = 3;
...
const unsigned short ConfigFileParser::N_PARAM_BOOL = 6;
const string ConfigFileParser::PARAM_BOOL[] = {
"probingDiscoverLAN", 
"probingProbeNetworkAddress", 
"probingSecondOpinion", 
...
const unsigned short ConfigFileParser::N_PARAM_INTEGER = 6;
...
void ConfigFileParser::parse(string inputFileName)
{
    ...
    while(std::getline(ss, targetStr, '\n'))
    {
        ...
        if(index != -1)
        {
            ...
            {
                case 0:
                    env->setExploringLANExplicitly(val);
                    break;
                case 1:
                    env->setUsingLowerBorderAsWell(val);
                    break;
                case 2:
                    env->setUsingDoubleProbe(val);
                    break;
                case 3:
        ...
        if(index != - 1)
        {
            ...
            switch(index)
            {
                ...
                case 1:
                    ...
                    {
                        nbErrors++;
                        (*out) << "Warning for key \"" << PARAM_INTEGER[1] << "\": provided ";
                ...
                case 2:
                    ...
                    {
                        nbErrors++;
                        (*out) << "Warning for key \"" << PARAM_INTEGER[2] << "\": ";
                        if(asInt <= 2 || asInt > 20)
                ...
                case 3:
                    ...
                    {
                        nbErrors++;
                        (*out) << "Warning for key \"" << PARAM_INTEGER[3] << "\": provided ";
                ...
                case 4:
                    ...
                    {
                        nbErrors++;
                        (*out) << "Warning for key \"" << PARAM_INTEGER[4] << "\": provided ";
                ...
                case 5:
                    ...
                    {
                        nbErrors++;
                        (*out) << "Warning for key \"" << PARAM_INTEGER[5] << "\": provided ";
