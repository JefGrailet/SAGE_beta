 ...
 * by ExploreNET, that is, without the subnet refinement step. This can be used to evaluate how 
 * much the refinement improved inference results, but it can also be helpful to understand 
 * difficult cases. Records should be written in a .xnet output file, with one record per line.
 *
