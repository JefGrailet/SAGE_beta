 ...
 *      Author: jefgrailet
 *
 * This class, inheriting Runnable, probes a pivot IP within a subnet with the TTL value 
 * corresponding to the index of a missing hop (which is either truly anonymous, either 
...
public:
    ...
    // Constructor
    AnonymousCheckUnit(Environment *env, 
...
private:
    ...
    // Pointer to environment singleton (with probing parameters)
    Environment *env;
