...
public:
    ...
    ************/
    ...
    inline bool doingSubnetMerging() { return this->subnetMerging; }
    ...
    ****************/
    ...
    /*
     * Method to fill the IP dictionnary with IPs found in both the interface list of each subnet 
     * and the route to each subnet. This operation is typically carried out after completing the 
     * parsing of the .subnets files.
     */
...
private:
    ...
    bool subnetMerging; // True if subnets should be checked for merging during parsing
