 ...
 * values to change the behavior of given phases. It is slightly different than in SAGE 
 * "Discovery" due to the absence of some algorithmic steps, making some keys irrelevant.
 */
